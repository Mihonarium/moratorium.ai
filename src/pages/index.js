...
const Quotes = [
  ...
  },
  {
    name: 'Elon Musk',
    title: 'SpaceX, Tesla',
    text: 'AI has the potential of civilizational destruction',
	link: 'https://www.inc.com/ben-sherry/elon-musk-ai-has-the-potential-of-civilizational-destruction.html',
  },
  {
    name: 'Demis Hassabis',
    title: 'the CEO of Google DeepMind',
    text: 'I would advocate not moving fast and breaking things. [...] When it comes to very powerful technologies—and obviously AI is going to be one of the most powerful ever—we need to be careful,” he says. “Not everybody is thinking about those things. It’s like experimentalists, many of whom don’t realize they’re holding dangerous material',
...
function SoleLink(href) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className=""><svg width="13.5" height="13.5" aria-hidden="true" viewBox="0 0 24 24" class="iconExternalLink_node_modules-@docusaurus-theme-classic-lib-theme-Icon-ExternalLink-styles-module"><path fill="currentColor" d="M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z"></path></svg></a>
  );
}
